#!/usr/bin/env python3
"""Rewrite quick-start.md and API_REFERENCE.md with accurate v2.0 API."""
from pathlib import Path

DOCS = Path(__file__).resolve().parent.parent / "docs"


def write_quick_start():
    (DOCS / "quick-start.md").write_text("""\
---
...
if __name__ == "__main__":
    print("Rewriting quick-start.md and API_REFERENCE.md...")
    write_quick_start()
    write_api_reference()
    print("Done!")
